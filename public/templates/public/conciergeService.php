...
<main>
    ...
    <div class="conciergePresentationOffer">
        <h3>Nos trois offres de conciergerie</h3>
        <p>Toutes nos maisons sont accompagnées de l'un de nos trois niveaux de conciergerie. Elles comprennent toujours un accueil clef en main et la présence d'une équipe locale pour que vous partiez l'esprit léger.</p>
        <p>Si vous souhaitez un niveau de conciergerie supérieur à celui prévu dans votre maison, vous pourrez sélectionner celui qui vous correspond le mieux au moment de votre réservation avec nos conseillers.</p>
    </div>
        ...
        <div class="conciergeOfferSub">
            ...
            <ul>
                <li>
                    ...
                    <p>Accueil clé en main</p>
                </li>
                <li>
                    <p><i class="fa-solid fa-people-group"></i></p>
                    <p>Une équipe locale</p>
                </li>
                <li class="unvailable">
                    <p><i class="fa-solid fa-house-user"></i></p>
                    <p>Personnalisation de votre séjour</p>
                </li>
                <li class="unvailable">
                    <p><i class="fa-solid fa-bell-concierge"></i></p>
                    <p>Suivi par votre conciergerie dédié</p>
                </li>
            </ul>
        </div>
        <div class="conciergeOfferSub">
    ...
    <div class="conciergeExplore">
        <a href="" class="goldenButton">Explorer nos logements</a>
        <p><i class="fa-solid fa-phone"></i><a href="#">Appeler un conseiller</a></p>
    </div>

    <div class="conciergeService">
        <h3>Piochez dans notre myriade de services exceptionnels</h3>
    ...
    <div class="conciergeExperience">
        <div class="conciergeExperienceContent">
            <h3>"Découvrez l'enchantement de Paris à travers des expériences uniques"</h3>
            <p>Des plus surprenantes aux plus mémorables, nos expériences exclusives sont soigneusement créées par nos concierges pour vous plonger dans l'atmosphère enchanteresse de votre séjour. Chaque expérience est conçue pour vous offrir des moments inoubliables, où votre cœur bat plus vite et où vous êtes captivé par l'instant présent. Ce sont ces instants magiques que vous chérirez et que vous raconterez encore des années plus tard.</p>
        </div>
