...
<div class="superContainer">
    <div class="Container">
        <h1>PARAMÈTRES</h1>
        <p class="descritionParametre">Votre vie privée est notre priorité, et nous veillons à ce que toutes les 
            mesures de sécurité appropriées soient en place pour garantir la protection de vos données confidentielles.</p>
